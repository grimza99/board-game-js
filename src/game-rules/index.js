...
GAME_DETAIL_MAP.set(65, G4.PANDEMIC_LEGACY_SEASON_1);
GAME_DETAIL_MAP.set(66, G4.DUNE_IMPERIUM);
GAME_DETAIL_MAP.set(67, G4.ARKHAM_HORROR_THE_CARD_GAME);
GAME_DETAIL_MAP.set(68, G4.NEMESIS);
GAME_DETAIL_MAP.set(69, G4.ECLIPSE);
GAME_DETAIL_MAP.set(70, G4.MAGE_KNIGHT_BOARD_GAME);
GAME_DETAIL_MAP.set(71, G4.ANACHRONY);
GAME_DETAIL_MAP.set(72, G4.TZOLK_IN_THE_MAYAN_CALENDAR);
GAME_DETAIL_MAP.set(73, G4.ON_MARS);
GAME_DETAIL_MAP.set(74, G4.JAIPUR);
GAME_DETAIL_MAP.set(75, G4.CAVERNA_THE_CAVE_FARMERS);
GAME_DETAIL_MAP.set(76, G4.PAX_PAMIR_SECOND_EDITION);
GAME_DETAIL_MAP.set(77, G4.THE_GALLERIST);
GAME_DETAIL_MAP.set(78, G4.UNDERWATER_CITIES);
